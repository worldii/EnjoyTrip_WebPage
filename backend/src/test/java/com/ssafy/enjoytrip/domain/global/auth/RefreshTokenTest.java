...
class RefreshTokenTest {
    ...
    void createRefreshToken() {
        assertThatCode(() -> RefreshToken.builder().tokenName("test").userId("test").build())
    ...
    void createRefreshTokenFailTokenName() {
        assertThatCode(() -> RefreshToken.builder().userId("test").build())
    ...
    void createRefreshTokenFailUserId() {
        assertThatCode(() -> RefreshToken.builder().tokenName("test").build())
                .isInstanceOf(IllegalArgumentException.class)
