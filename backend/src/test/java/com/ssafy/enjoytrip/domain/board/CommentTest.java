...
class CommentTest {
    ...
    void createCommentWithNullBoardId() {
        ...
        assertThatCode(
                        () -> {
                            Comment.builder().commentId(1L).userId("test").content("test").build();
                        })
    ...
    void createCommentWithNullUserId() {
        ...
        assertThatCode(
                        () -> {
                            Comment.builder().commentId(1L).boardId(1L).content("test").build();
                        })
                .isInstanceOf(BoardException.class)
    ...
    void createCommentWithNullContent() {
        ...
        assertThatCode(
                        () -> {
                            Comment.builder().commentId(1L).boardId(1L).userId("test").build();
                        })
                .isInstanceOf(BoardException.class)
